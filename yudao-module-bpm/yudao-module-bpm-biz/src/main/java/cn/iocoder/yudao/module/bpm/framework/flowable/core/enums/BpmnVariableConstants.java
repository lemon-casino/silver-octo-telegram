...
public class BpmnVariableConstants {
    ...
    /**
     * 流程实例的变量 - 节点类型：节点是会签（多人会签）
     */
    public static final String PROCESS_INSTANCE_VARIABLE_NODE_RATIO_TYPE = "NODE_RATIO_TYPE_%s";

    /**
     * 流程实例的变量 - 节点类型：节点是或签（多人或签）
     */
    public static final String PROCESS_INSTANCE_VARIABLE_NODE_ANY_TYPE = "NODE_ANY_TYPE_%s";
