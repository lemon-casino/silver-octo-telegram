...
import cn.iocoder.yudao.module.bpm.service.message.dto.BpmMessageSendWhenTaskCopyReqDTO;
...
public class BpmProcessInstanceCopyServiceImpl implements BpmProcessInstanceCopyService {
    ...
    public void createProcessInstanceCopy(Collection<Long> userIds, String reason, String processInstanceId,
        ...
        List<BpmProcessInstanceCopyDO> copyList = convertList(userIds, userId -> new BpmProcessInstanceCopyDO()
                .setUserId(userId).setReason(reason).setStartUserId(FlowableUtils.getProcessInstanceStartUserId(processInstance))
        ...
        for (Long userId : userIds) {
            messageService.sendMessageWhenTaskCopy(new BpmMessageSendWhenTaskCopyReqDTO()
                    .setUserId(userId)
