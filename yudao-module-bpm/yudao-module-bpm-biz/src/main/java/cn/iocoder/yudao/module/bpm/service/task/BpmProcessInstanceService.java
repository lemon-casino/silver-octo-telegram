...
public interface BpmProcessInstanceService {
     ...
     * @return 流程实例分页结果
     */
    PageResult<HistoricProcessInstance> getProcessInstanceList(@Valid BpmProcessInstancePageReqVO pageReqVO);
     ...
     * @return 流程实例的统计信息
     */
    BpmProcessInstanceStatsRespVO getProcessInstanceStats(Long userId);
     ...
     * @param cancelReqVO 取消信息
     */
    void cancelProcessInstanceByAdmin(Long userId, @Valid BpmProcessInstanceCancelReqVO cancelReqVO);
