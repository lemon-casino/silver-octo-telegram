...
public interface ErrorCodeConstants {
    ...
    ErrorCode PROCESS_INSTANCE_CANCEL_FAIL_NOT_MANAGER = new ErrorCode(1_009_004_006, "流程删除失败，你不是流程管理员");
    ...
    // Add this constant to the ErrorCodeConstants class
    ErrorCode TASK_RETURN_REASON_REQUIRED = new ErrorCode(1002016003, "退回理由不能为空");
